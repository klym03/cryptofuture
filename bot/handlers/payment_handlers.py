...
async def handle_subscribe(callback_query: types.CallbackQuery):
    ...
    try:
        await callback_query.message.edit_text(
            ...
            "Напишіть @nin_0009 для оформлення підписки!",
            reply_markup=InlineKeyboardMarkup(
                inline_keyboard=[
                    [
                        InlineKeyboardButton(
                            text="✉️ Написати @nin_0009", 
                            url="https://t.me/nin_0009"
                        )
                    ],
                    [
                        InlineKeyboardButton(
...
async def handle_subscription_info(callback_query: types.CallbackQuery):
    ...
    try:
        await callback_query.message.edit_text(
            ...
            "💬 <b>Для оформлення:</b>\n"
            "Зверніться до @nin_0009 для отримання підписки",
            reply_markup=InlineKeyboardMarkup(
                inline_keyboard=[
                    [
                        InlineKeyboardButton(
